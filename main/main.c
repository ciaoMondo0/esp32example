...
extern const uint8_t certificatogithub0_pem_start[] asm("_binary_certificatogithub0_pem_start");
extern const uint8_t certificatogithub0_pem_end[] asm("_binary_certificatogithub0_pem_end");
...
void advanced_ota_example_task(void *pvParameter)
{
    ...
    esp_http_client_config_t config = {
        ...
        .cert_pem = (const char *)certificatogithub0_pem_start,  // Usa il certificato personalizzato
        .timeout_ms = 5000,
